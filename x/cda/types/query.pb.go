...
type QueryApprovalsRequest struct {
	CdaId string `protobuf:"bytes,1,opt,name=cdaId,proto3" json:"cdaId,omitempty"`
}
...
func (m *QueryApprovalsRequest) GetCdaId() string {
	if m != nil {
		return m.CdaId
	}
	return ""
...
type QueryApprovalsResponse struct {
	Approvals string `protobuf:"bytes,1,opt,name=approvals,proto3" json:"approvals,omitempty"`
}
...
var fileDescriptor_6e4aace556501a3a = []byte{
	...
	,
}
...
func (m *QueryApprovalsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CdaId) > 0 {
		i -= len(m.CdaId)
		copy(dAtA[i:], m.CdaId)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.CdaId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryApprovalsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Approvals) > 0 {
		i -= len(m.Approvals)
		copy(dAtA[i:], m.Approvals)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Approvals)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryApprovalsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.CdaId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
...
func (m *QueryApprovalsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Approvals = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
