...
archived tx wasm execute \
archive14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9scewqtq \
'{ "set_signing_data": { "ownerships": [{ "owner": "address", "ownership_proportion": 1 }]} }' \
--from val-0 \
--chain-id localarchive \
--fees 0.001token -y
