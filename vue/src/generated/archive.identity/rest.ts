...
export type IdentityMsgUpdateOperatorsResponse = object;
...
export interface IdentityQueryIdentityMembersResponse {
  members?: string[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryOperators
   * @summary Queries a list of Operators items.
   * @request GET:/archive/identity/operators/{id}
   */
  queryOperators = (
    id: string,
    query?: {
    ...
    this.request<IdentityQueryOperatorsResponse, RpcStatus>({
      path: `/archive/identity/operators/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
