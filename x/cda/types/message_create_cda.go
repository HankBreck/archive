...
func NewMsgCreateCda(creator string, signingParties []string, contractId uint64, legalMetadataUri string, signingData *types.Any, utcExpireTime time.Time) *MsgCreateCda {
	return &MsgCreateCda{
		Creator:          creator,
