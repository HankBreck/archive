...
export enum CDAContractStatus {
  Pending = "Pending",
  Finalized = "Finalized",
  Voided = "Voided",
}

export interface CdaCDA {
  creator?: string;
...
export interface CdaQueryApprovalResponse {
  approved?: boolean;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/archive/cda/approval/{cdaId}
   */
  queryApproval = (cdaId: string, query?: { owner?: string }, params: RequestParams = {}) =>
    this.request<CdaQueryApprovalResponse, RpcStatus>({
      path: `/archive/cda/approval/${cdaId}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/archive/cda/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CdaQueryParamsResponse, RpcStatus>({
      path: `/archive/cda/params`,
      method: "GET",
      format: "json",
      ...params,
    });
