...
/**
 * @title archive/contractregistry/contract.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryContracts
   * @request GET:/archive/contractregistry/contracts
   */
  queryContracts = (
    query?: {
    ...
    this.request<ContractregistryQueryContractsResponse, RpcStatus>({
      path: `/archive/contractregistry/contracts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/archive/contractregistry/params
   */
