...
import { WeightedVoteOption } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "archive-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "archive-client-ts/cosmos.gov.v1beta1/types"
