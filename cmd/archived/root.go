...
func initAppConfig() (string, interface{}) {
	...
	srvCfg.MinGasPrices = "0token" // TODO: Update fee types

	// 128MB IAVL cache
	srvCfg.IAVLCacheSize = 781250

	// TODO: Update to extend config if needed (e.g. adding wasm module)
	return "", nil
}
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		PrepareGenesisCmd(app.ModuleBasics, app.DefaultNodeHome),
		debugCmd,
		config.Cmd(),
	)
...
func (a appCreator) appExport(logger log.Logger, db dbm.DB, traceStore io.Writer, height int64, forZeroHeight bool,
