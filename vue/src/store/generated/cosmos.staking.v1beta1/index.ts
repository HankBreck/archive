...
import { StakeAuthorization } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "archive-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "archive-client-ts/cosmos.staking.v1beta1/types"
